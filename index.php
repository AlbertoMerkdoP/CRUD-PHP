                        ...
                        <div class="tab-content" id="nav-tabContent">
                            <div class="tab-pane fade show active" id="list-login" role="tabpanel"
                                ...
                                <form action="config/Authenticate.php" method="POST">
                                    ...
                                    $mensaje_id = isset($_GET['mensaje']) ? (int) $_GET['mensaje'] : null; //Cambiar 0 por null, para evitar error al cargar pagina
                                    $mensaje = '';
                            ...
                            <div class="tab-pane fade" id="list-register" role="tabpanel"
                                ...
                                <form action="config/Register.php" method="POST" name="forregistro">
                                    ...
                                    <div class="form-group">
                                        <label for="email">Correo electrónico</label>
                                        <input type="email" class="form-control" id="emailregis" name="emailregis"
                                    ...
                                    <input type="button" class="btn btn-primary" onclick="ValidarRegistro()"
                                        value="Registrar">
                                </form>
                            </div>
